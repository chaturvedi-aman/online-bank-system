<table><%
       ...
       PreparedStatement ps3= null;
		...
		if(status==true){
			...
			//Class.forName("com.mysql.jdbc.Driver");
			 con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/akash","root","");
		   ...
		   ps1=con1.prepareStatement("update NEWACCOUNT set amount=? where accountno='"+taccountno+"'");
			...
			request.setAttribute("target account A ",dataamount);
				//Class.forName("com.mysql.jdbc.Driver");
			 con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/akash","root","");
			...
			//	Class.forName("com.mysql.jdbc.Driver");
			 con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/akash","root","");
